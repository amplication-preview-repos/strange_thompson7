...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [Parent], { name: "parents" })
  async findParents(
  ...
  @graphql.ResolveField(() => [Kid], { name: "kids" })
  async findKids(
    @graphql.Parent() parent: User,
    @graphql.Args() args: KidFindManyArgs
  ): Promise<Kid[]> {
    const results = await this.service.findKids(parent.id, args);
