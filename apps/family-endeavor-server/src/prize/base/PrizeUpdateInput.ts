...
class PrizeUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PrizeProgressUpdateManyWithoutPrizesInput,
  })
  @ValidateNested()
  @Type(() => PrizeProgressUpdateManyWithoutPrizesInput)
  @IsOptional()
  @Field(() => PrizeProgressUpdateManyWithoutPrizesInput, {
    nullable: true,
  })
  prizeProgresses?: PrizeProgressUpdateManyWithoutPrizesInput;
}

export { PrizeUpdateInput as PrizeUpdateInput };
