...
@InputType()
class ProgressCreateNestedManyWithoutEndeavorsInput {
...
export { ProgressCreateNestedManyWithoutEndeavorsInput as ProgressCreateNestedManyWithoutEndeavorsInput };
