...
class EndeavorUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => EndeavorProgressUpdateManyWithoutEndeavorsInput,
  })
  @ValidateNested()
  @Type(() => EndeavorProgressUpdateManyWithoutEndeavorsInput)
  @IsOptional()
  @Field(() => EndeavorProgressUpdateManyWithoutEndeavorsInput, {
    nullable: true,
  })
  endeavorProgresses?: EndeavorProgressUpdateManyWithoutEndeavorsInput;
}

export { EndeavorUpdateInput as EndeavorUpdateInput };
